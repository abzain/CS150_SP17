...
//         System.out.println("Test RedBlackTreePhoneBase ...");
//         test(new RedBlackTreePhoneBase( ), insertCount, selectCount);

        System.out.println("Test ArrayListPhoneBase ...");
        test(new ArrayListPhoneBase( ), insertCount, selectCount);

        System.out.println("Test HashSetPhoneBase ...");
        test(new HashSetPhoneBase( ), insertCount, selectCount);
    }

    // test insertCount-many insertions and selectCount-many selections on a given PhoneBase
    public static void test(PhoneBase b, int insertCount, int selectCount) {
        final int GAP  =  35461;
